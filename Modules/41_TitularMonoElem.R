...
CalibraMonoIndividualServer <- function(input, output, session, devMode, balanzas,
                                        Elemento, LeadAM, u_LeadAM,
                                        sampleID, dscrMuestraMonoelemTit,
                                        BalanzaMonoelemTit,
                                        DisEDTA_MRC, IDUsuario, number, fecha) {
