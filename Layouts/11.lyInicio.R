         ...
         column(
           ...
           tags$ul(
             tags$li(
               ...
               tags$div(style = 'font-size:8px', 'La lista de tipos de cantidades QUDT aceptadas se pueden encontrar en',
                        tags$a(href = 'https://qudt.org/2.1/vocab/quantitykind', 'https://qudt.org/2.1/vocab/quantitykind'))),
                        # 'El uso de la etiqueta quantityTypeQUDT se',
