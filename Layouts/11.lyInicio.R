inicioLy <- fluidRow(
    column(12, 
      box(title = div(style = 'font-size:25px', tags$b('Introducción')), width = 12, status = 'primary', collapsible = TRUE, collapsed = FALSE,
            h4("Esta aplicación se utiliza para el manejo de datos de los siguientes protocolos de medicion:", tags$br(),
               tags$ul(
               ...
               tags$br(), tags$br(), "Los certificados de calibración digitales de las balanzas son los descritos en la documentación del paquete de R ", 
